...
Commander of `git`, `Terraform`, `Go`, `Typescript` on `node.js`, `linux` systems, networking.
...
:busts_in_silhouette: [Schedule an interview with me]
...
[Schedule an interview with me]: https://calendly.com/rcambrj/interview
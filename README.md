...
* Implemented and maintained RDS, DynamoDB, S3 and related network infrastructure
* Proactively found and fixed accounting synchronisation errors, avoiding tax fines

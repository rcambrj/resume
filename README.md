...
Passionate about _readable_, _scalable_, _observable_ & _secure_ code.\
...
:telephone_receiver: +31 203 699 866 [call now]\
:envelope: robert@cambridge.me\
:link: [linkedin.com/in/rcambrj]\
:octocat: [github.com/rcambrj]\
:busts_in_silhouette: [Schedule a meeting]\
:printer: [Download PDF]

## Certifications

[<img alt="AWS Certified Solutions Architect - Associate" src="./assets/aws-saa-c03.png" width="113" height="113" />](https://www.credly.com/badges/32632bc5-4297-418f-bb92-12cffde9a9e9) [<img alt="CNCF Certified Kubernetes Application Developer" src="./assets/cncf-cka.png" width="113" height="113" />](https://www.credly.com/badges/009819e3-1307-48ca-bdce-86c810675d29) [<img alt="CNCF Certified Kubernetes Application Developer" src="./assets/cncf-ckad.png" width="113" height="113" />](https://www.credly.com/badges/009819e3-1307-48ca-bdce-86c810675d29)

## Experience

### Backend Engineer, Biogroup via Cygnus Red + FikaWorks, remote [01/2026 - 06/2026]
* Developed `Typescript` backend services across authentication, patient results & appointments
* Architected `WebAuthn`/passkey authentication with `Redis` challenge storage
* Implemented typed `RPC` clients/controllers for service-to-service operations
* Designed composable authorisation guards with strongly typed inferred composition
* Developed healthcare result-enhancement logic with custom ruleset backoffice
* Hardened backend APIs with wildcard `CORS` support & strict `zod` validation
* Modernised `node.js` services across the platform to v24 & updated various dependencies
* Expanded unit and integration test coverage around various facets of the product

### Platform Engineer, Supabase via numtide, remote [09/2025 - 10/2025]
* Bootstrapped `Go`/`Kubebuilder` `Kubernetes` operator structure with `nix`, `direnv`, module layout
* Implemented GitHub Actions CI/CD for pull requests, releases, container image builds with `Docker`
* Hardened container builds using pinned dependencies, `distroless`/`alpine` & `Grype` scanning
* Implemented controller logic for Kubernetes deployment & service
* Improved local developer experience workflows with `make`, adding sample resources in a local cluster

### Backend Engineer, Frasers Group via Lab Digital, Utrecht [03/2024 - 10/2024]
* Maintained & developed `Typescript` high traffic e-commerce backend running alongside `commercetools`
* Created & fixed `Terraform` infrastructure architecting the `AWS` `Lambda` & `ECS` services
* Improved & maintained `RESTful` and `GraphQL` API features
* Introduced `nix` devshell to make onboarding & distribution of tooling easier
* Configured `nix` package for `MACH Composer` and worked with this tool daily

### Platform Engineer, VanMoof via MA Micro Ltd, Amsterdam [10/2023 - 01/2024]
...
* Assisted with the development of new internal API services written in `Go`
...
### Backend Engineer, VanMoof, Amsterdam [07/2021 - 05/2023]
* Developed API services in `Go` (`golang` `Lambdas` via `Terraform`)
* Developed API services in `Serverless.js` (`node.js` `Lambdas` via `CloudFormation`)
...
### Lead Frontend Engineer, Polestar via code d'azur, Amsterdam [09/2020 - 07/2021]
...
### Lead Fullstack Engineer, PON Occasions via Dept, Amsterdam [01/2020 - 06/2020]
...
### Backend Engineer, [ABN AMRO Incubator] via Dept, Amsterdam [01/2020 - 02/2020]
...
* Bootstrapped sane `node.js` `Typescript` configuration and linting
...
### Frontend Engineer, Etos via Dept, Amsterdam [09/2019 - 12/2019]
...
### Lead Frontend Engineer, Activia via AKQA, Amsterdam [05/2019 - 08/2019]
...
### Frontend Engineer, Imperial Tobacco/Fontem (blu.com), Amsterdam [01/2019 - 04/2019]
...
### Fullstack Engineer, Ace & Tate, Amsterdam [10/2018 - 12/2018]
...
### Fullstack Engineer, Gain Theory via Tweag IO, London [03/2018 - 07/2018]
...
### Software Engineer, Wonderbill via Boston Consulting Group, London [07/2016 - 02/2018]
...
### Frontend Engineer, NHS England via Web Technology Group, London [01/2016 - 06/2016]
* Developed a web-based CMS-like document management intranet site running `reactjs/redux` powered by `Nuxeo`

### Frontend Engineer, Arcadia Group, London [08/2015 - 12/2015]
...
### Frontend Engineer, Square Enix, London [03/2015 - 06/2015]
...
### Fullstack Engineer, Expedia, London [12/2014 - 02/2015]
...
### Frontend Engineer, Square Enix, London [05/2014 - 10/2014]
* Developed the website for a video game in `backbone` and `marionette`
* Created a cross-domain consumer authentication (SSO) library for company-wide roll out

### Lead Frontend Engineer, Sportlobster, London [01/2014 - 03/2014]
* Led & mentored a team of 3 frontend developers using Javascript

### Fullstack Engineer, Boxlight, London [10/2010 - 12/2013]
...
[call now]: https://rcambrj.github.io/resume/callme.html
[linkedin.com/in/rcambrj]: https://linkedin.com/in/rcambrj
[github.com/rcambrj]: https://github.com/rcambrj
[Schedule a meeting]: https://cal.com/rcambrj/meet
